const managerApi = {
  apiKey: "d0ac294cd8589979b823e4a5bd7fd8c2",
...
//Вызов добавления постов

// managerApi.addPost({
//   title: "post 1 title",
//   seo_url: "post-1-title",
//   full_description: "post-1-full-title dfafsdfsdafsdafsadfds",
...
const managerView = {
  ...
  addPost() {
    ...
    managerApi.sendPost({
      ...
      short_decription: this.shortDescription.value
    }).then(()=> {
       managerApi.getPosts(50, 1).then(data => this.renderPosts(data.posts));
